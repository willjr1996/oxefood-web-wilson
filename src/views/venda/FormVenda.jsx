...
export default function FormVenda() {
    ...
    const venda = [
        { key: 'Pedido Cancelado', text: 'Pedido Cancelado', value: 'Pedido Cancelado' },
        { key: 'Aguardando Pagamento', text: 'Aguardando Pagamento', value: 'Aguardando Pagamento' },
    ...
    function salvar() {
        ...
        // } else { //Cadastro:
            axios.post("http://localhost:8080/api/venda", vendaRequest)
                ...
                .catch((error) => { 
                    alert('Erro ao incluir a venda.'); 
                    console.log('Erro ao incluir o venda.'); 
                })
        //}
    }
                    ...
                    <div style={{ marginTop: '4%' }}>
                        ...
                        <div style={{ marginTop: '4%' }}>
                            ...
                            <Button
                                ...
                                floated='right'
                                disabled = {
                                    !cliente || !produto || !dataVenda || 
                                    !statusVenda || !valorTotal ||
                                    !observacao
                                }
                                onClick={() => salvar()}
                            >
